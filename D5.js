...
const OnlyTitles = function() {
  ...
  return titles; //not sure it has to return something per the request
}
...
const SumYear = function() {
  ...
  let today = new Date();
  for (let i = 0; i < movies.length; i++) {
    sum_years = today.getFullYear() - movies[i].Year;
